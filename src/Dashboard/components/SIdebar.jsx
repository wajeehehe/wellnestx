  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
        <IconButton variant="soft" color="sucess" size="sm">
          <Forest color="success" />
        </IconButton>
        <Typography level="title-lg" color="success">WellNestX</Typography>
        ...
        >
          ...
          <ListItem>
            ...
            >
              ...
              <ListItemContent>
                <Typography level="title-sm">Talk to AI Chatbot</Typography>
              </ListItemContent>
            </ListItemButton>
          </ListItem>
          <ListItem nested>
